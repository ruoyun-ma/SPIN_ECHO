...
public enum U implements GeneratorParamEnum {
    ...
    DIXON_FAT_PERIODE("DIXON_FAT_PERIODE") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(0.002235416567795707);
    ...
    FIELD_OF_VIEW_3D("FIELD_OF_VIEW_3D") {
        public Param build() {
            ...
            param.setValue(0.010000000000000002);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    FIRST_PUT_2D("FIRST_PUT_2D") {
        public Param build() {
            NumberParam param = new NumberParam();
            param.setName("FIRST_PUT_2D");
            param.setDisplayedName("PAT - First Put 2D");
            param.setDescription("First line of acquisition in phase direnction (when PAT is used)");
            param.setCategory(Category.Acquisition);
            param.setUuid("70f50f40-bbd1-46b8-888b-82e05f2b1fc1");
            param.setNumberEnum(NumberEnum.Scan);
            param.setMinValue(0);
            param.setMaxValue(2147483647);
            param.setValue(2);
    ...
    GRADIENT_AREA_CRUSHER("GRADIENT_AREA_CRUSHER") {
        public Param build() {
            ...
            param.setMaxValue(1.7976931348623157E308);
            param.setValue(1.5874006014705875E-5);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    GRADIENT_AREA_CRUSHER_PI("GRADIENT_AREA_CRUSHER_PI") {
        public Param build() {
            ...
            param.setMinValue(-1.7976931348623157E308);
            param.setMaxValue(1.7976931348623157E308);
            param.setValue(1.0138127251286133);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    MAGNETIC_FIELD_STRENGTH("MAGNETIC_FIELD_STRENGTH") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(3.0018813806920517);
    ...
    NB_REF_LINES_2D("NB_REF_LINES_2D") {
        public Param build() {
            NumberParam param = new NumberParam();
            param.setName("NB_REF_LINES_2D");
            param.setDisplayedName("PAT - No. Ref Lines 2D");
            param.setDescription("Number of reference lines in phase encoding direction");
            param.setCategory(Category.Acquisition);
            param.setUuid("cdf3a51f-c3ab-4f52-a75d-63df937249ad");
            param.setNumberEnum(NumberEnum.Scan);
            param.setMinValue(0);
            param.setMaxValue(2147483647);
            param.setValue(10);
    ...
    PAF_2D("PAF_2D") {
        public Param build() {
            NumberParam param = new NumberParam();
            param.setName("PAF_2D");
            param.setDisplayedName("PAT - Factor 2D");
            param.setDescription("PAT Acceleration Factor in Phase direction");
            param.setGroup(EnumGroup.Scan);
            param.setCategory(Category.Acquisition);
            param.setUuid("0d7164a5-b596-491c-80a2-30a9678ad38a");
            param.setNumberEnum(NumberEnum.Scan);
            param.setMinValue(1);
            param.setMaxValue(2147483647);
            param.setValue(3);
    ...
    SPECTRAL_WIDTH_PER_PIXEL("SPECTRAL_WIDTH_PER_PIXEL") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.7976931348623157E308);
            param.setValue(391.2510016025641);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_AMP_180("TX_AMP_180") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(76.16152549848972);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_AMP_90("TX_AMP_90") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(49.10664195149967);
            param.setDefaultValue(0.0);
            return param;
        }
    },
