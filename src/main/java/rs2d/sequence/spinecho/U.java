...
public enum U implements GeneratorParamEnum {
    ...
    GRADIENT_AREA_CRUSHER("GRADIENT_AREA_CRUSHER") {
        public Param build() {
            ...
            param.setMaxValue(1.7976931348623157E308);
            param.setValue(-2.7001538080404036E-5);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    GRADIENT_AREA_CRUSHER_PI("GRADIENT_AREA_CRUSHER_PI") {
        public Param build() {
            ...
            param.setMinValue(-1.7976931348623157E308);
            param.setMaxValue(1.7976931348623157E308);
            param.setValue(-5.747277380413999);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    RESOLUTION_PHASE("RESOLUTION_PHASE") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(4.4642857142857147E-4);
            param.setDefaultValue(5.0E-4);
            return param;
        }
    },
    ...
    SEQ_DESCRIPTION("SEQ_DESCRIPTION") {
        public Param build() {
            ...
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setValue("SE_2D_AXI_256x224x12_ETL=8");
            param.setDefaultValue("");
            return param;
        }
    },
    ...
    SPECTRAL_WIDTH_PER_PIXEL("SPECTRAL_WIDTH_PER_PIXEL") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E8);
            param.setValue(136.72750056003585);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_AMP_180("TX_AMP_180") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(88.90271226221948);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_AMP_90("TX_AMP_90") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(44.405318553523024);
            param.setDefaultValue(0.0);
            return param;
        }
    },
