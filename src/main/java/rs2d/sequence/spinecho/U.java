...
public enum U implements GeneratorParamEnum {
    ...
    FATSAT_TX_LENGTH("FATSAT_TX_LENGTH") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(0.006136363636363637);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    FSE_TRAIN_TEST("FSE_TRAIN_TEST") {
        public Param build() {
            BooleanParam param = new BooleanParam();
            param.setName("FSE_TRAIN_TEST");
            param.setDisplayedName("FSE_TRAIN_TEST");
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setValue(true);
            param.setDefaultValue(false);
    ...
    SEQUENCE_TIME("SEQUENCE_TIME") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(154.83140500000002);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TRANSFORM_PLUGIN("TRANSFORM_PLUGIN") {
        public Param build() {
            ...
            param.setGroup(EnumGroup.Scan);
            param.setCategory(Category.Acquisition);
            param.setValue("Sequential2DInterleaved");
    ...
    TX_AMP_180("TX_AMP_180") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(87.166959040919);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_AMP_90("TX_AMP_90") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(44.30025851993182);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_LENGTH_180("TX_LENGTH_180") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(0.0020350000000000004);
            param.setDefaultValue(0.0);
            return param;
        }
    },
