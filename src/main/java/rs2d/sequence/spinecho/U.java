...
public enum U implements GeneratorParamEnum {
    ...
    ACQUISITION_MATRIX_DIMENSION_1D("ACQUISITION_MATRIX_DIMENSION_1D") {
        public Param build() {
            ...
            param.setDescription("Acquisition size of the first dimension");
            param.setGroup(EnumGroup.Scan);
            param.setCategory(Category.Acquisition);
    ...
    ACQUISITION_MATRIX_DIMENSION_2D("ACQUISITION_MATRIX_DIMENSION_2D") {
        public Param build() {
            ...
            param.setDescription("Acquisition size of the second dimension");
            param.setGroup(EnumGroup.Scan);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Scan);
            param.setMinValue(0);
    ...
    ACQUISITION_MATRIX_DIMENSION_3D("ACQUISITION_MATRIX_DIMENSION_3D") {
        public Param build() {
            ...
            param.setDescription("Acquisition size of the third dimension");
            param.setGroup(EnumGroup.Scan);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Scan);
            param.setMinValue(0);
    ...
    ACQUISITION_MATRIX_DIMENSION_4D("ACQUISITION_MATRIX_DIMENSION_4D") {
        public Param build() {
            ...
            param.setDescription("Acquisition size of the fourth dimension");
            param.setGroup(EnumGroup.Scan);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Scan);
            param.setMinValue(0);
    ...
    ACQUISITION_TIME_OFFSET("ACQUISITION_TIME_OFFSET") {
        public Param build() {
            ...
            param.setValue(asListNumber(0.0, 0.005, 0.011, 0.016, 0.022, 0.027, 0.033, 0.038, 0.044, 0.049, 0.055, 0.06, 0.066, 0.071, 0.076, 0.082, 0.087, 0.093, 0.098, 0.104, 0.109, 0.115, 0.12, 0.126, 0.131, 0.137, 0.142, 0.147, 0.153, 0.158, 0.164, 0.169));
    ...
    ACQUISITION_TIME_PER_SCAN("ACQUISITION_TIME_PER_SCAN") {
        public Param build() {
            ...
            param.setDescription("Acquisition time per scan");
            param.setGroup(EnumGroup.Reception);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(9.142272E-4);
    ...
    ECHO_SPACING("ECHO_SPACING") {
        public Param build() {
            ...
            param.setValue(0.0054600000000000004);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    ECHO_TIME("ECHO_TIME") {
        public Param build() {
            ...
            param.setDescription("Echo time ( TE ) ");
            param.setGroup(EnumGroup.Delay);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(0.08736000000000001);
    ...
    FATSAT_TX_AMP("FATSAT_TX_AMP") {
        public Param build() {
            ...
            param.setDisplayedName("FATSAT_TX_AMP");
            param.setDescription("90° for FS; 45° for WEP");
            param.setGroup(EnumGroup.Emission);
            param.setCategory(Category.Acquisition);
    ...
    FATSAT_WEP_TX_LENGTH("FATSAT_WEP_TX_LENGTH") {
        public Param build() {
            NumberParam param = new NumberParam();
            param.setName("FATSAT_WEP_TX_LENGTH");
            param.setDisplayedName("FATSAT_WEP_TX_LENGTH");
            param.setDescription("");
            param.setGroup(EnumGroup.Delay);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Time);
    ...
    FAT_SATURATION_WEP_ENABLED("FAT_SATURATION_WEP_ENABLED") {
        public Param build() {
            BooleanParam param = new BooleanParam();
            param.setName("FAT_SATURATION_WEP_ENABLED");
            param.setDisplayedName("FAT_SATURATION_WEP_ENABLED");
    ...
    FLIP_ANGLE("FLIP_ANGLE") {
        public Param build() {
            ...
            param.setDescription("Flip angle for the excitation (FA)");
            param.setGroup(EnumGroup.Emission);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Angle);
    ...
    GRADIENT_AMP_CRUSHER_IR("GRADIENT_AMP_CRUSHER_IR") {
        public Param build() {
            ...
            param.setDescription("Magnitude of the crusher gradient after the Inversion pulse");
            param.setGroup(EnumGroup.Gradient);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.PERCENT);
            param.setMinValue(0.0);
    ...
    GRADIENT_PHASE_APPLICATION_TIME("GRADIENT_PHASE_APPLICATION_TIME") {
        public Param build() {
            ...
            param.setDescription("Application time of the phase encoding gradient");
            param.setGroup(EnumGroup.Delay);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(0.0);
    ...
    GRADIENT_READ_PREPHASING_APPLICATION_TIME("GRADIENT_READ_PREPHASING_APPLICATION_TIME") {
        public Param build() {
            ...
            param.setDescription("Gradient application time");
            param.setGroup(EnumGroup.Delay);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(0.0);
    ...
    INVERSION_TIME_MULTI("INVERSION_TIME_MULTI") {
        public Param build() {
            ...
            param.setDisplayedName("Multi TI");
    ...
    LAST_PUT("LAST_PUT") {
        public Param build() {
            ...
            param.setMaxValue(2147483647);
            param.setNumberEnum(NumberEnum.Integer);
            param.setValue(asListNumber(253, 27, 0, 0, 0));
    ...
    MAGNETIC_FIELD_STRENGTH("MAGNETIC_FIELD_STRENGTH") {
        public Param build() {
            ...
            param.setDescription("Magnetic field tregth");
            param.setLockedToDefault(true);
            param.setGroup(EnumGroup.Miscellaneous);
            param.setCategory(Category.Acquisition);
    ...
    MODALITY("MODALITY") {
        public Param build() {
            ...
            param.setDescription("Modality for the acquisition");
            param.setLockedToDefault(true);
            param.setGroup(EnumGroup.Miscellaneous);
            param.setCategory(Category.Acquisition);
            param.setValue("MRI");
    ...
    MULTISERIES_PARAMETER_VALUE("MULTISERIES_PARAMETER_VALUE") {
        public Param build() {
            ...
            param.setMaxValue(1.7976931348623157E308);
            param.setNumberEnum(NumberEnum.Double);
            param.setValue(asListNumber(87.36, 174.72, 262.08, 349.44, 436.8, 524.16, 611.52, 698.88, 786.24, 873.6, 960.96, 1048.32, 1135.68, 1223.04, 1310.4, 1397.76, 1485.12, 1572.48, 1659.84, 1747.2, 1834.56, 1921.92, 2009.28, 2096.64, 2184.0, 2271.36, 2358.72, 2446.08, 2533.44, 2620.8, 2708.16, 2795.52));
            param.setDefaultValue(asListNumber(0.0));
            return param;
        }
    },
    ...
    NUMBER_OF_SHOOT_3D("NUMBER_OF_SHOOT_3D") {
        public Param build() {
            ...
            param.setDescription("Number of scan 3D for transform 3D");
            param.setGroup(EnumGroup.Dimension);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Scan);
            param.setMinValue(1);
    ...
    PROBE("PROBE") {
        public Param build() {
            ...
            param.setDescription("Probe used for the mr acquisition");
            param.setGroup(EnumGroup.Miscellaneous);
            param.setCategory(Category.Acquisition);
            param.setValue("");
            param.setDefaultValue("");
    ...
    PROBES("PROBES") {
        public Param build() {
            ...
            param.setDescription("Probes used for the acquisition");
            param.setLocked(true);
            param.setGroup(EnumGroup.Miscellaneous);
            param.setCategory(Category.Acquisition);
            param.setValue(asList("3T Volume Coil"));
            return param;
        }
    },
    ...
    RECEIVER_COUNT("RECEIVER_COUNT") {
        public Param build() {
            ...
            param.setDescription("Number of receivers");
            param.setGroup(EnumGroup.Reception);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Integer);
            param.setMinValue(1);
    ...
    REPETITION_TIME("REPETITION_TIME") {
        public Param build() {
            ...
            param.setDescription("Repetition time  ( TR ) ");
            param.setGroup(EnumGroup.Delay);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(2.1414);
    ...
    SEQUENCE_TIME("SEQUENCE_TIME") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(25.696805000000005);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    SEQ_DESCRIPTION("SEQ_DESCRIPTION") {
        public Param build() {
            ...
            param.setDescription("");
            param.setCategory(Category.Acquisition);
            param.setValue("SE_2D_AXI_32x32x12_ETL=32");
            param.setDefaultValue("");
            return param;
        }
    },
    ...
    SPECTRAL_WIDTH("SPECTRAL_WIDTH") {
        public Param build() {
            ...
            param.setDescription("Spectral width of the reception");
            param.setGroup(EnumGroup.Reception);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.SW);
            param.setMinValue(0.0);
            param.setMaxValue(1.0E8);
            param.setValue(35002.24014336918);
    ...
    SPECTRAL_WIDTH_PER_PIXEL("SPECTRAL_WIDTH_PER_PIXEL") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E8);
            param.setValue(1093.8200044802868);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_AMP_180("TX_AMP_180") {
        public Param build() {
            ...
            param.setDescription("Magnitude of the RF pulse 180");
            param.setGroup(EnumGroup.Emission);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.TxAmp);
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(86.20127284611489);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_AMP_90("TX_AMP_90") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(46.54868418532411);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_LENGTH_180("TX_LENGTH_180") {
        public Param build() {
            ...
            param.setDescription("Duration of the 180 RF pulse");
            param.setGroup(EnumGroup.Emission);
            param.setCategory(Category.Acquisition);
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(0.0);
    ...
    TX_SHAPE_180("TX_SHAPE_180") {
        public Param build() {
            ...
            param.setDescription("Shape of the RF pulse");
            param.setCategory(Category.Acquisition);
            param.setValue("SINC3");
            param.setDefaultValue("HARD");
            param.setSuggestedValues(asList("HARD", "GAUSSIAN", "SINC3", "SINC5", "SLR_8_5152", "SLR_4_2576"));
